...
describe("Extra Runs conceded per team", () => {
  ...
  it("5 matches of 2016", () => {
    expect(functions(matchinputfivematch, fivedeliveries)).toStrictEqual(outputfivedeliveries);
  });
  
  test("Check for empty input", () => {
    expect(functions(distributedmatch, distributeddelivery)).toStrictEqual(distributedoutput);
  });
  test("Check for empty input", () => {
